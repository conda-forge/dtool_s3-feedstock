About dtool_s3-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dtool_s3-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6452&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dtool_s3-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dtool_s3` can be installed with `conda`:
...
```
mamba install dtool_s3
```

It is possible to list all of the versions of `dtool_s3` available on your platform with `conda`:
...
```
mamba search dtool_s3 --channel conda-forge
```
...
mamba repoquery search dtool_s3 --channel conda-forge

# List packages depending on `dtool_s3`:
mamba repoquery whoneeds dtool_s3 --channel conda-forge

# List dependencies of `dtool_s3`:
mamba repoquery depends dtool_s3 --channel conda-forge
```
